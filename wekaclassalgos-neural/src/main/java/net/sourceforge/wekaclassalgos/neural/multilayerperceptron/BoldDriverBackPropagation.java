package net.sourceforge.wekaclassalgos.neural.multilayerperceptron;
...
import net.sourceforge.wekaclassalgos.neural.multilayerperceptron.algorithm.BoldDriverBackPropagationAlgorithm;
...
public class BoldDriverBackPropagation extends WekaAlgorithmAncestor
{
    ...
    protected NeuralModel prepareAlgorithm(Instances instances) throws java.lang.Exception
    {
        ...
        BoldDriverBackPropagationAlgorithm algorithm = new BoldDriverBackPropagationAlgorithm(
            function, rand, lrateFunction, momentum, weightDecay, biasInput, hiddenLayersTopology, instances, errorIncreaseAdjustment, errorDecreaseAdjustment);
