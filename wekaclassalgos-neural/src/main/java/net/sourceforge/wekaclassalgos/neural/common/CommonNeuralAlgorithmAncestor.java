package net.sourceforge.wekaclassalgos.neural.common;
        ...
        implements NeuralModel
{
     ...
     *
     * @param instance
     *            - the instance to retrieve the class distribution for
     * @return double - class distribution vecotr for classification problems otherwise the raw network output for regression problems
     */
